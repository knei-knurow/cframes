...
uint8_t* frames_create(uint8_t* header, uint8_t* data, int data_len);
...
uint8_t* frames_data(uint8_t frame, int data_len);
...
bool frames_verify(uint8_t* frame, int frame_len);
...
uint8_t frames_calculate_checksum(uint8_t* frame, int frame_len);
